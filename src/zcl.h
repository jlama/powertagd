...
enum {
	...
	ZCL_METERING_POWER_FACTOR = 0x0006, // int8 (0-99%)
	...
	ZCL_METERING_SE_POWERTAG_ENERGY_DELIVERED_PHASE_A = 0x410c, // uint48
	ZCL_METERING_SE_POWERTAG_ENERGY_DELIVERED_PHASE_B = 0x420c, // uint48
	ZCL_METERING_SE_POWERTAG_ENERGY_DELIVERED_PHASE_C = 0x430c, // uint48

	// TODO: unknown 'delivered' values
	// 0x4000 uint48
	// 0x410d uint48
	// 0x420d uint48
	// 0x430d uint48

	ZCL_METERING_SE_POWERTAG_ENERGY_RECEIVED_PHASE_A = 0x410e, // uint48
	ZCL_METERING_SE_POWERTAG_ENERGY_RECEIVED_PHASE_B = 0x420e, // uint48
	ZCL_METERING_SE_POWERTAG_ENERGY_RECEIVED_PHASE_C = 0x430e, // uint48

	// TODO: unknown 'received' values
	// 0x4013 uint48
	// 0x410f uint48
	// 0x420f uint48
	// 0x430f uint48
