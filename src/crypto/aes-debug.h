 ...
 */
void aes_hexdump_ascii(int level, const char *title, const void *buf, size_t len);
 ...
 */
void aes_hexdump_ascii_key(int level, const char *title, const void *buf, size_t len);
